...
import static com.movieapp.konwo.sweetbaking.models.local.IngredientContract.CONTENT_AUTHORITY;
import static com.movieapp.konwo.sweetbaking.models.local.IngredientContract.Entry.TABLE_NAME;
...
public class IngredientsProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri,
        ...
        Cursor retCursor = queryBuilder.query(database, projection, selection, selectionArgs,
                null, null, null);
